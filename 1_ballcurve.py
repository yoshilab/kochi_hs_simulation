...
simulation(speed=150, degree=70, color="red", g=9.8) # 初速v0, 角度degree, 重力加速度g の投げ上げを赤でプロット
simulation(speed=150, degree=60, color="purple", g=9.8) # 初速v0, 角度degree, 重力加速度g の投げ上げを赤でプロット
simulation(speed=150, degree=45, color="gray", g=9.8) # 初速v0, 角度degree, 重力加速度g の投げ上げを赤でプロット
simulation(speed=150, degree=30, color="orange", g=9.8) # 初速v0, 角度degree, 重力加速度g の投げ上げを赤でプロット
