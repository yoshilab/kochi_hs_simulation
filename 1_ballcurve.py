...
simulation(speed=162, degree=60, color="purple", g=9.8) # 初速v0=162キロ, 角度60度, 重力加速度g=9.8 の投げ上げを紫でプロット
simulation(speed=162, degree=30, color="gray", g=9.8) # 初速v0=162キロ, 角度30度, 重力加速度g=9.8 の投げ上げを灰色でプロット
simulation(speed=162, degree=10, color="orange", g=9.8) # 初速v0=162キロ, 角度10度, 重力加速度g=9.8 の投げ上げを橙色でプロット
